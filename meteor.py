...
token = "Njc0Mjk4ODU5MDM5NzUyMTkz.XjwR3w.ffMCMT-SGE8NhtpbVIGRqSBWf2A"
...
async def on_ready():
    ...
    print("ready")
    await client.change_presence(status=discord.Status.online, activity=discord.Game("홍보 테스트"))
